...
class LDAformer(nn.Module):
    def __init__(self, seq_len, d_input, d_model=12, n_heads=1, e_layers=4, d_ff=0.5, pos_emb=True, value_linear=True, value_sqrt=False, add=True, norm=True, ff=True, dropout=0.05):
